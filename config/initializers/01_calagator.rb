...
Calagator.setup do |config|
  # Site name
  config.title = "New York City Maritime Calendar"

  # Site tagline
  config.tagline = "Life on the waters of New York City"

  # Site URL with trailing slash
  config.url = "https://maritime.nyc/"

  # Email address of administrator that will get exception notifications
  # and requests for assistance from users:
  config.administrator_email = "zach@maritime.nyc"
